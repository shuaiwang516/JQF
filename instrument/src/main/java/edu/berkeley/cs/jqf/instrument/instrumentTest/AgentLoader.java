...
public final class AgentLoader {
     ...
     */
    public static boolean loadJQFAgent() {
        ...
        try {
            ...
            Log.d2f("Allow Attach Self " + Boolean.getBoolean("jdk.attach.allowAttachSelf"));
            Log.d2f("111");
            ...
            Log.d2f("444");
            URL agentJarURL = Types.extractJarURL(Agent.class);
            Log.d2f("555");
    ...
    public static void main(String[] args) {
        System.out.println(loadJQFAgent());
    }
}
